...
// Recursão é o nome do efeito que a função recursiva gera ao executá-la inúmeras vezes
...
// Para construir uma função recursiva, geralmente partimos de um caso de base para garantir que nossa função não vai continuar se chamando para sempre
